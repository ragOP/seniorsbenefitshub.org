        ...
        <>
          <div className="main-container-5">
            ...
            <div style={{marginTop:'-5px'}} className="survey">
              ...
              <div  className=
              "answer">
              {quiz === "Select Your Age:  " && <div className="answer-btn-5" onClick={handleQuizPositive} style={{"textTransform": "capitalize"}}>
              {fourth}
                </div>}
                <div className="answer-btn-5" onClick={handleQuizPositive}>
              {yes}
                </div>
                <div className="answer-btn-5" onClick={handleQuizNegative}>
              {no}
                </div>
               <div className="answer-btn-5" onClick={handleQuizPositive}>
              {third}
